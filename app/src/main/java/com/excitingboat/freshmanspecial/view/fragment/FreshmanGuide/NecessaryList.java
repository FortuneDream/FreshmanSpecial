...
public class NecessaryList extends Fragment {
    ...
    private void initView() {
        ...
        content.setText(Html.fromHtml("携带少量现金（毕竟不是所有的地方都可以使用支付宝的）<BR><font color='#000'><big>洗护用品方面</big> </font><BR>男生的剃须刀，女生的护肤品（男生也可以适当准备一些)" +
                "常洗漱需要的物品（诸如牙膏牙刷，毛巾，沐浴露，盆桶一" +
                "类），以及洗衣物所需要的洗衣液，刷子等等<BR><font color='#000'><big>衣物方面</big> </font><BR>四季的外套、袜子等等（要是重庆本地的同学或者是经常回" +
                "家的同学非当季的衣物可以不用携带），各种晾衣物的工具" +
                "（如衣叉，衣架等等）<BR><font color='#000'><big>寝室住宿方面</big> </font><BR>大部分小鲜肉是会去品尝皇家1,5,6的滋味的，寝室空间比较小。蚊帐（根据个人喜好，也可以采用驱蚊液，这样就可以不挂蚊帐）一些基本的床上用品（枕头，被子等，被单最" +
