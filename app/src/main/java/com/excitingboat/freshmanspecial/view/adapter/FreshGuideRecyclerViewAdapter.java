 ...
 */
public abstract class FreshGuideRecyclerViewAdapter extends RecyclerView.Adapter<FreshGuideRecyclerViewAdapter.MyViewHolder> implements View.OnClickListener {
    protected List data;
